...
def generate_teaching_script(raw_text, language_mode, prompt_override):
    ...
    if prompt_override:
        ...
        Wrap Hindi words or phrases in the script using <lang xml:lang="hi-IN">...</lang> inside a <speak> block and in hindi text script, to ensure accurate pronunciation when read by Google Text-to-Speech
